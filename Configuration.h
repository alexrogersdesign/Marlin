...
#define STRING_CONFIG_H_AUTHOR "Alex Rogers" // Who made the changes.
...
// Ultimaker
//Using Values from Example Hemera?
...
#define Z_SAFE_HOMING_X_POINT (80) // X point for Z homing when homing all axes (G28).
